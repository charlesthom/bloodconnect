      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome to BloodConnect!</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                {{-- <div class="mb-3">
                  <select class="form-control" name="blood_type" id="blood_type" aria-label="blood_type" aria-describedby="blood_type">
                ...
                <div class="mb-3">
                  <input type="date" class="form-control" placeholder="Birth Date" name="birth_date" id="birth_date" aria-label="Birth Date" aria-describedby="birth_date" value="{{ old('birth_date') }}">
                  @error('birth_date')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <select class="form-control" name="gender" id="gender" aria-label="gender" aria-describedby="gender">
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Phone Number" name="phone" id="phone" aria-label="Phone Number" aria-describedby="phone" value="{{ old('phone') }}">
                  @error('phone')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Location" name="location" id="location" value="{{ old('location') }}" required readonly>
                </div>
...
<script>
  ...
  //       },
  //       function (error) {
  //         alert("You must allow location to access this page.");
