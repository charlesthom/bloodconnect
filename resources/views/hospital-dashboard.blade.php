...
<div class="position-relative overflow-hidden border-radius-xl p-4">
  ...
  <!-- White Overlay -->
  <div class="position-absolute top-0 start-0 w-100 h-100 border-radius-xl"
       style="background: rgba(255,255,255,0.90); z-index: 1;"></div>
...
<div class="icon icon-shape bg-gradient-danger shadow text-center border-radius-md">                  <i class="ni ni-time-alarm text-lg opacity-10" aria-hidden="true"></i>
  ...
  <div class="card">
    <div class="card-body p-3">
      <div class="row">
        <div class="col-8">
          <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Donors</p>
          <h5 class="font-weight-bolder mb-0">
            {{ $total_donor_count }}
          </h5>
        </div>
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <div class="icon icon-shape bg-gradient-danger shadow text-center border-radius-md">
              <i class="ni ni-ambulance text-lg opacity-10"></i>
            </div>
          </div>
        </div>
      </div>
...
@endif
      <div class="card-body p-3">
        ...
        <form action="{{ route('hospital.export.filtered.pdf') }}" method="GET">
          <div class="row align-items-end">
            ...
            <div class="col-md-3 mb-3">
              <button type="submit" class="btn w-100" style="background:#800000;color:white;">
                Export PDF
              </button>
            </div>
