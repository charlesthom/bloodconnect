<div class="modal fade" id="approveRescheduleRequestModal" tabindex="-1" aria-labelledby="approveRescheduleRequestModalLable" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow-lg border-radius-xl">
        <div class="modal-header">
            <h5 class="modal-title font-weight-bold" id="approveRescheduleRequestModalLable">Confirm Reschedule Request?</h5>
