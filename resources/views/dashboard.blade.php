    ...
    <div class="row">
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <div class="card">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <a href="{{ route('export.users') }}" class="btn btn-sm" style="background-color: #800000; color: white; border: none;">
              Export
            </a>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <div class="card">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <a href="{{ route('export.hospitals') }}" class="btn btn-sm" style="background-color: #800000; color: white; border: none;">
              Export
            </a>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <div class="card">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <a href="{{ route('export.donation-requests') }}" class="btn btn-sm" style="background-color: #800000; color: white; border: none;">
              Export
            </a>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-sm-6">
        <div class="card">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <a href="{{ route('export.blood-requests') }}" class="btn btn-sm" style="background-color: #800000; color: white; border: none;">
              Export
            </a>
          </div>
        </div>
