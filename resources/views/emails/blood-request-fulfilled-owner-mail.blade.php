...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <h2>Hello, {{ $bloodRequest->hospital->name }}!</h2>

            <p>
                Good news! Your <strong>Blood Request</strong> has been fulfilled by
                <strong>{{ $bloodRequest->confirmedBy->name }}</strong>.
            </p>

            <p>
                Please coordinate with the fulfilling hospital for further details.
            </p>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>{{ $bloodRequest->confirmedBy->name }}</td>
